...
public class NativeImageIT extends AbstractAppTests {
    ...
    private static final Future<String> IMAGE_FUTURE = new LazyFuture<>() {
        ...
        protected String resolve() {
            ...
            if (System.getProperty("os.arch").contains("aarch")) {
                return String.format("dashaun/com.javagrunt.service.youtube:v%s-aarch_64", semanticVersion);
            } else {
                return String.format("dashaun/com.javagrunt.service.youtube:v%s-amd_64", semanticVersion);
            }
        }
    };
    ...
    static final GenericContainer<?> APP = new GenericContainer<>(IMAGE_FUTURE)
            ...
            .withEnv("DATASOURCE_URL","jdbc:postgresql://postgres:5432/")
            .withEnv("DATASOURCE_USERNAME",postgreSQLContainer.getUsername())
            .withEnv("DATASOURCE_PASSWORD",postgreSQLContainer.getPassword())
